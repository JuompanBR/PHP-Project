...
class Db
{
    ...
    public function read(string $tableName)
    {
        ...
        // Generate query
        static $query = "SELECT * FROM " . $tableName . " LIMIT " . Config::values['resultsLimit'] . " ;";
        // Execute the query
    ...
    public function get(
        ...
        // Generate the query 
        static $query = "SELECT * FROM " . $tableName . " WHERE " . $criteria . " == " . $value;
        // Execute the query
        $stmt = $this->pdo->query($query);
    ...
    public function delete(
        ...
        // Generate the query 
        static $query = "DELETE FROM " . $tableName . " WHERE " . $criteria . " == " . $value;
        // Execute the query
        $stmt = $this->pdo->query($query);
